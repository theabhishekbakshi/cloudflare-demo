import { playerReviewsRouter  } from "./routes/player_review";
...
export async function route(req: Request, env: Env) {
  ...
  if (pathname.startsWith("/player-reviews")) { return playerReviewsRouter (req, env); }
  if (pathname.startsWith("/player-reviews-admin")) { return playerReviewsRouter (req, env); }
